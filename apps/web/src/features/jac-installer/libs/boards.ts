...
//   } catch (e) {
//     console.error(e);
//     enqueueSnackbar('Failed to load boards index.', { variant: 'error' });
//     return [];
//   }
// }
...
//       `${BOARD_INDEX_URL}/${boardId}/${BOARD_VERSIONS_JSON}`
//     );
//     const res = await response;
//     return await res.json();
//   } catch (e) {
//     console.error(e);
//     enqueueSnackbar('Failed to load board versions.', { variant: 'error' });
//     return [];
//   }
// }

// export function getBoardVersionFirmwareTarUrl(
//   boardId: string,
//   version: string
// ): string {
