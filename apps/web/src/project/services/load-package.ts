...
import { loadPackageFromBytes, type PackageLoadResult } from '@jaculus/project/import';

// Load package from a browser File object (ZIP or TAR.GZ).
export async function loadPackageFromFile(file: File): Promise<PackageLoadResult> {
